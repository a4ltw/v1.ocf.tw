...
![OCF 成員於 FOSDEM 與聯盟成員 Boris Baldassari 合照][image4]
***OCF Ian 於 FOSDEM 與聯盟成員 Boris Baldassari 合照***

OCF 也持續與國內企業及政府單位合作，推動導入 GGI 框架與 OSPO 治理原則，致力於強化台灣在國際開源治理網絡中的角色。
...
「建立 OSPO，不是一件遙不可及的事。這本手冊，就是給你第一步。」
OSPO 是什麼？怎麼起步？如何評估組織內部的開源程度為何？到哪些階層？
如何逐步設計策略、建立治理流程、讓幕僚行政人事部門也一同參與推動？

當開放原始碼及其衍生的生態系一同被視為一項資產，而不只是可用的免費程式碼或資源，才能讓更多人參與其中、讓公共價值真正發生。
